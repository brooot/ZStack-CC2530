...
//        {
//          /* Fill up what we can */
//          pMsg->hdr.event = CMD_SERIAL_MSG;  //注册事件号 CMD_SERIAL_MSG
...
//        {
//          osal_msg_send( App_TaskID, (byte *)pMsg ); //***把数据包发送到OSAL层
//        }
//        else
//        {
//          /* deallocate the msg */
//          osal_msg_deallocate ( (uint8 *)pMsg );  //清理申请的内存空间
//        }
//
