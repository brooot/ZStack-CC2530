...
#define HAL_KEY_SW_6_BIT    BV(0) //原BV(1)
#define HAL_KEY_SW_6_SEL    P0SEL
#define HAL_KEY_SW_6_DIR    P0DIR

/* edge interrupt 边缘触发方式*/
#define HAL_KEY_SW_6_EDGEBIT  BV(0)
#define HAL_KEY_SW_6_EDGE     HAL_KEY_FALLING_EDGE
//HAL_KEY_FALLING_EDGE下降沿触发  ，  HAL_KEY_RISING_EDGE 上升沿触发
...
#define HAL_KEY_SW_6_ICTLBIT  BV(0) /* P0IEN - P0.1 enable/disable bit *///原BV(1)
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  /* Register the callback fucntion 注册回调函数--重点*/
...
//  }
  ...
  {
    /* Key interrupt handled here 在此处理按键中断*/
  }
  ...
  /* Invoke Callback if new keys were depressed 调用注册的回调函数，即上面的 OnBoard_KeyCallback*/
